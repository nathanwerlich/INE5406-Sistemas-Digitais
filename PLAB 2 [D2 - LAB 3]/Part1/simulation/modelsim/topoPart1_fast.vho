...
ARCHITECTURE structure OF topoPart1 IS
...
-- Equation(s):
-- \L1|S_g~combout\ = LCELL((\SW~combout\(0) & \SW~combout\(2)))
...
-- Equation(s):
-- \L1|Qb~combout\ = LCELL((!\L1|S_g~combout\ & !\L1|Qa~combout\))
...
-- Equation(s):
-- \L1|R_g~combout\ = LCELL((\SW~combout\(1) & \SW~combout\(2)))
...
-- Equation(s):
-- \L1|Qa~combout\ = LCELL((!\L1|Qb~combout\ & !\L1|R_g~combout\))

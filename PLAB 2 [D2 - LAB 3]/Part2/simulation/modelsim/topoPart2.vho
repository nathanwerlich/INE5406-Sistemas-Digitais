...
ARCHITECTURE structure OF topoPart2 IS
...
-- Equation(s):
-- \L1|S_g~combout\ = LCELL((\SW~combout\(0) & \SW~combout\(1)))
...
-- Equation(s):
-- \L1|R_g~combout\ = LCELL((!\SW~combout\(0) & \SW~combout\(1)))
